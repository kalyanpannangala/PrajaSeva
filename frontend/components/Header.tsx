...
// --- Mock User Data (pass this as a prop in a real app) ---
const MOCK_USER = {
  name: 'Kalyan',
  avatarUrl: 'https://placehold.co/100x100/E9ECEF/003366?text=K'
};
                        ...
                        {isDropdownOpen && (
                            ...
                            >
                                <div className="p-4 border-b">
                                    <p className="font-bold text-[#003366]">{MOCK_USER.name}</p>
